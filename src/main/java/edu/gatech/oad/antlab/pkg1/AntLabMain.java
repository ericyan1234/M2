 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Eric Yan");
		  toPrint += p1.toString("eyan30");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Peter Han");
		  toPrint += p2.toString("phan38");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Daniel Lee");
		  toPrint += p3.toString("dlee760");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Caitlin Yang");
                  toPrint += p4.toString("hyang388");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Francis Kim");
                  toPrint += p5.toString("fkim30");
